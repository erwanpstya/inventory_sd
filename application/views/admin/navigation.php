  ...
  <div class="sidebar-inner slimscrollleft"> 
    ...
    <div id="sidebar-menu">
      <ul>
        ...
        <li class="<?php if($active_menu==2) {echo "active"; } ?>"> <a href="<?php echo base_url().'index.php?admin/computer'?>" class="waves-effect waves-light <?php if($active_menu==2) {echo "active"; } ?>" id="53"><i class="fa fa-desktop" aria-hidden="true"></i><span> PC &amp; Laptop </span> </a></li>
        <li class="<?php if($active_menu==3) {echo "active"; } ?>"> <a href="<?php echo base_url().'index.php?admin/device'?>" class="waves-effect waves-light <?php if($active_menu==3) {echo "active"; } ?>" id="53"><i class="fa fa-print" aria-hidden="true"></i><span>Equipment </span> </a></li>
        ...
        <!-- <li class="<?php if($active_menu==12) {echo "active"; } ?>"> <a href="<?php echo base_url().'index.php?admin/backup_try'?>" class="waves-effect waves-light <?php if($active_menu==12) {echo "active"; } ?>" id="53"><i class="fa fa-database"></i><span>Database Backup Try</span></a></li> -->
      </ul>
