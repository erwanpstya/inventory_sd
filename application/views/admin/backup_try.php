          ...
          <div class="panel panel-border panel-success">
            ...
            <div class="panel-body"> 
              ...
              <div class="col-sm-offset-3 col-sm-6 m-t-15">
                      <!--perintah backup before -->
                <a href="<?php echo base_url().'index.php?admin/backup_restore/create'?>"
                class="btn btn-md btn-block btn-success">Download Backup </a> <br>
                    <!--perintah backup try -->
                <a href="<?php echo base_url();?>'index.php?admin/backup_try">
