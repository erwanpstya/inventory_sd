...
<meta name="description" content="-SDN BOJONG GEDE">
<meta name="author" content="STAFF IT">
<meta name="copyright" content="Copyright (c) 2024 STAFF TI">
<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/images/favicon.ico">
<title>Sistem Inventory SDN 05 Kedung Waringin</title>
<!--Morris Chart CSS -->
...
<div id="wrapper"> 
  ...
  <div class="topbar"> 
    ...
    <div class="topbar-left">
      <div class="text-center"> <a href="<?php echo base_url();?>" class="logo"> <img src="assets/images/logo-mini.png"  style="margin-top:25px;margin-left:10px;" class="icon-magnet icon-c-logo" alt="Unit TI PSSN"> <span><img src="assets/images/favicon.png"  style="margin-top:15px;margin-left:-25px;" class="md md-album" alt="Unit TI PSSN"></span> </a> </div>
    </div>
